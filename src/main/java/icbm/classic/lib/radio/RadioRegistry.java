...
public final class RadioRegistry {
     ...
     */
    public static final IBoundBox<BlockPos> INFINITE =
        new BoundBlockPos(-Integer.MAX_VALUE, -Integer.MAX_VALUE, -Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
