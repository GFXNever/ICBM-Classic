...
public class TileLauncherScreen extends TileMachine implements ILauncherComponent, IMachineInfo, IPlayerUsing, IGuiTile {
    ...
    public static final PacketCodexTile<TileLauncherScreen, TileLauncherScreen> PACKET_GUI =
        (PacketCodexTile<TileLauncherScreen, TileLauncherScreen>) new PacketCodexTile<TileLauncherScreen, TileLauncherScreen>(REGISTRY_NAME,
            "description")
            .fromServer()
    ...
    public static final PacketCodexTile<TileLauncherScreen, RadioScreen> PACKET_RADIO_HZ =
        (PacketCodexTile<TileLauncherScreen, RadioScreen>) new PacketCodexTile<TileLauncherScreen, RadioScreen>(REGISTRY_NAME, "radio.frequency",
            (t) -> t.radioCap)
            .fromClient()
            .nodeString(RadioScreen::getChannel, RadioScreen::setChannel)
            .onFinished((r, t, p) -> r.markDirty());
    public static final PacketCodexTile<TileLauncherScreen, RadioScreen> PACKET_RADIO_DISABLE =
        (PacketCodexTile<TileLauncherScreen, RadioScreen>) new PacketCodexTile<TileLauncherScreen, RadioScreen>(REGISTRY_NAME, "radio.disable",
            (t) -> t.radioCap)
            .fromClient()
            .toggleBoolean(RadioScreen::isDisabled, RadioScreen::setDisabled)
            .onFinished((r, t, p) -> r.markDirty());
    public static final PacketCodexTile<TileLauncherScreen, TileLauncherScreen> PACKET_TARGET =
        (PacketCodexTile<TileLauncherScreen, TileLauncherScreen>) new PacketCodexTile<TileLauncherScreen, TileLauncherScreen>(REGISTRY_NAME, "target")
            .fromClient()
            .nodeVec3d(TileLauncherScreen::getTarget, TileLauncherScreen::setTarget)
            .onFinished((r, t, p) -> r.markDirty());
    public static final PacketCodexTile<TileLauncherScreen, TileLauncherScreen> PACKET_LAUNCH =
        (PacketCodexTile<TileLauncherScreen, TileLauncherScreen>) new PacketCodexTile<TileLauncherScreen, TileLauncherScreen>(REGISTRY_NAME, "launch")
            .fromClient()
            .onFinished((r, t, p) -> {
