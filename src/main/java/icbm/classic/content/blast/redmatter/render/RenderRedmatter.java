...
public class RenderRedmatter extends Render<EntityRedmatter> {
    ...
    public static final ResourceLocation TEXTURE_FILE =
        new ResourceLocation(ICBMConstants.DOMAIN, ICBMConstants.TEXTURE_DIRECTORY + "entity/redmatter/blackhole.png");
