...
public class RenderLightBeam extends Render<EntityLightBeam> {
    ...
    public static void renderBeamSegment(double x, double y, double z,
        ...
        renderBeamTube(x, y, z, height, color_red, color_green, color_blue, tessellator, bufferbuilder, nw_corner_x, nw_corner_z, ne_corner_x,
            ne_corner_z, sw_corner_x, sw_corner_z, se_corner_x, se_corner_z, uv_bottom, uv_top);
