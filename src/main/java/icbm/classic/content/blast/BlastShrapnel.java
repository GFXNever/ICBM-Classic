        ...
        if (!world().isRemote) {
            ...
            for (int i = 0; i < this.getBlastRadius(); i++) {
                ...
                for (int ii = 0; ii < this.getBlastRadius(); ii++) {
                    ...
                    EntityFragments arrow =
                        new EntityFragments(world(), location.x(), location.y() + 0.5, location.z(), this.isExplosive, this.isAnvil);
                    ...
                    arrow.setArrowHeading(arrow.motionX * world().rand.nextFloat(), arrow.motionY * world().rand.nextFloat(),
                        arrow.motionZ * world().rand.nextFloat(), 0.5f + (0.7f * world().rand.nextFloat()), 1.0F);
