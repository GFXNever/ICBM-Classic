...
public class BlastTNT extends Blast {
    ...
    public boolean doExplode(int callCount) {
        ...
        this.world()
            .playSound(null, this.location.x(), this.location.y(), this.location.z(), SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.BLOCKS, 4.0F,
                ...
                if (blockState.getMaterial() != Material.AIR) {
                    try {
                        ...
                        if (blockState.getBlock().canDropFromExplosion(this)) {
                            blockState.getBlock()
                                .dropBlockAsItemWithChance(this.world(), blockDestroyedPos, blockState, 1.0F / this.getBlastRadius(), 0);
                        }
