...
public class EntityFragments extends Entity implements IEntityAdditionalSpawnData {
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            for (this.rotationPitch = (float) (MathHelper.atan2(this.motionY,
                (double) flatMag) * (180D / Math.PI)); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
                ;
            }
            ...
            if (this.isInWater()) {
                ...
                for (int i = 0; i < 4; ++i) {
                    this.world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX - this.motionX * motionMultiplier,
                        this.posY - this.motionY * motionMultiplier, this.posZ - this.motionZ * motionMultiplier, this.motionX, this.motionY,
                        this.motionZ);
                }
    ...
    protected void onHit(RayTraceResult raytraceResultIn) {
        ...
        if (entity != null) {
            ...
            DamageSource damagesource =
                new EntityDamageSourceIndirect("arrow", this, shootingEntity).setProjectile(); //TODO track source, TODO custom damage type
            ...
            final IProjectileBlockInteraction.EnumHitReactions reaction =
                ProjectileBlockInteraction.handleSpecialInteraction(world, inTilePosition, raytraceResultIn.hitVec, raytraceResultIn.sideHit, inTile,
                    this);
            if (reaction.stop) {
                return;
            }
    ...
    protected Entity findEntityOnPath(Vec3d start, Vec3d end) {
        ...
        List<Entity> entityList = this.world.getEntitiesInAABBexcluding(this,
            this.getEntityBoundingBox().expand(this.motionX * 1.2, this.motionY * 1.2, this.motionZ * 1.2).grow(1.0D), e -> e.canBeCollidedWith());
        double d0 = 0.0D;
