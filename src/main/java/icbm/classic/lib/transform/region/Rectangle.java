...
public class Rectangle extends Shape2D {
    ...
    public String toString() {
        ...
        return "Rectangle[" + BigDecimal.valueOf(min.x()).setScale(precision, RoundingMode.HALF_UP) + ", " + BigDecimal.valueOf(min.y())
            .setScale(precision, RoundingMode.HALF_UP) + "] -> [" + BigDecimal.valueOf(max.x())
            .setScale(precision, RoundingMode.HALF_UP) + ", " + BigDecimal.valueOf(max.y()).setScale(precision, RoundingMode.HALF_UP) + "]";
    }
