...
public class TileRadarStation extends TileMachine implements IMachineInfo, IGuiTile, IPlayerUsing {
    ...
    public static final PacketCodexTile<TileRadarStation, TileRadarStation> PACKET_DESCRIPTION =
        (PacketCodexTile<TileRadarStation, TileRadarStation>) new PacketCodexTile<TileRadarStation, TileRadarStation>(REGISTRY_NAME, "description")
            .fromServer()
            .nodeEnum(EnumRadarState.class, (t) -> t.radarVisualState, (t, e) -> t.radarVisualState = e);
    public static final PacketCodex<TileRadarStation, IRadioChannelAccess> PACKET_RADIO_HZ =
        GeneralCodexs.radioChannel(REGISTRY_NAME, (tile) -> tile.radio);
    public static final PacketCodex<TileRadarStation, Radio> PACKET_RADIO_DISABLE =
        GeneralCodexs.radioToggleDisable(REGISTRY_NAME, (tile) -> tile.radio);
    public static final PacketCodexTile<TileRadarStation, TileRadarStation> PACKET_TRIGGER_RANGE =
        (PacketCodexTile<TileRadarStation, TileRadarStation>) new PacketCodexTile<TileRadarStation, TileRadarStation>(REGISTRY_NAME, "range.trigger")
            .fromClient()
            .nodeInt(TileRadarStation::getTriggerRange, TileRadarStation::setTriggerRange);
    public static final PacketCodexTile<TileRadarStation, TileRadarStation> PACKET_DETECTION_RANGE =
        (PacketCodexTile<TileRadarStation, TileRadarStation>) new PacketCodexTile<TileRadarStation, TileRadarStation>(REGISTRY_NAME,
            "range.detection")
            .fromClient()
            .nodeInt(TileRadarStation::getDetectionRange, TileRadarStation::setDetectionRange);
    public static final PacketCodexTile<TileRadarStation, TileRadarStation> PACKET_REDSTONE_OUTPUT =
        (PacketCodexTile<TileRadarStation, TileRadarStation>) new PacketCodexTile<TileRadarStation, TileRadarStation>(REGISTRY_NAME,
            "redstone.output")
            .fromClient()
            .toggleBoolean(TileRadarStation::isOutputRedstone, TileRadarStation::setOutputRedstone);
    public static final PacketCodexTile<TileRadarStation, TileRadarStation> PACKET_GUI =
        (PacketCodexTile<TileRadarStation, TileRadarStation>) new PacketCodexTile<TileRadarStation, TileRadarStation>(REGISTRY_NAME, "gui")
            .fromServer()
            .nodeInt(TileRadarStation::getTriggerRange, TileRadarStation::setTriggerRange)
            .nodeInt(TileRadarStation::getDetectionRange, TileRadarStation::setDetectionRange)
            ...
            .node((t) -> t.radarRenderData.getDots(), (t, dots) -> t.radarRenderData.setDots(dots), RadarRenderData::encodeDots,
                RadarRenderData::decodeDots);
    ...
    public static void register() {
        ...
        PacketCodexReg.register(PACKET_DESCRIPTION, PACKET_GUI, PACKET_RADIO_HZ, PACKET_RADIO_DISABLE, PACKET_DETECTION_RANGE, PACKET_TRIGGER_RANGE,
            PACKET_REDSTONE_OUTPUT);
    }
    ...
    public void update() {
        ...
        if (preRadarVisualState != radarVisualState) {
            this.markDirty();
            this.world.markAndNotifyBlock(pos, null, getBlockState().withProperty(BlockRadarStation.RADAR_STATE, preRadarVisualState),
                getBlockState().withProperty(BlockRadarStation.RADAR_STATE, radarVisualState), 3);
    ...
    private void doScan() //TODO document and thread
    {
        ...
        final List<Entity> entities =
            RadarRegistry.getAllLivingObjectsWithin(world, getPos().getX() + 0.5, getPos().getY() + 0.5, getPos().getZ() + 0.5,
                Math.min(detectionRange, MAX_DETECTION_RANGE));
    ...
    public boolean isMissileGoingToHit(IMissile missile) {
        ...
        double nextDistance =
            mpos.addVector(missile.getMissileEntity().motionX, missile.getMissileEntity().motionY, missile.getMissileEntity().motionZ)
                .distanceTo(rpos);   // next distance from missile to radar
